      ...
      <section id="quienes_somos" className="main__article">
        ...
        <article className="mt-2">
          ...
          <p className="p-3 pt-2 pb-0 article__text">
            <span className="article__text--green" aria-valuetext="MISIÓN">MISIÓN</span>. Facilitar el
            desarrollo sostenible de un negocio.
          </p>
          <p className="p-3 pt-2 pb-0 article__text">
            <span className="article__text--green" aria-valuetext="VISIÓN">VISIÓN</span>. Ser la
          ...
          <p className="p-3 pt-2 article__text">
            <span className="article__text--green" aria-valuetext="VALORES">VALORES</span>. Compromiso,
